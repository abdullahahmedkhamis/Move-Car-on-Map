...
import commerce.amazoncommerce.traning.ReAndLog.SplashScreenActivity;
...
public class DriverHomeActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == PICK_IMAGE_REQUEST && resultCode == Activity.RESULT_OK)
        {
            if(data != null && data.getData() != null)
            {
                ...
                img_avatar.setImageURI( imagUri );
    ...
    private void shuwDialogeUpload() {
        AlertDialog.Builder builder = new AlertDialog.Builder( DriverHomeActivity.this );
        builder.setTitle( "Change pictuer" )
                .setMessage( "Do you really want to change pictuer?" )
    ...
    private void init() {
        ...
        txt_star.setText( Common.currentUser != null ? String.valueOf( Common.currentUser.getRating( 1 ))  : "0.0");   // Was want number 1
