...
import commerce.amazoncommerce.traning.DriverHomeActivity;
import commerce.amazoncommerce.traning.MainActivity3;
...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    @BindView(R.id.progressBar)  // progress_bar
...
e.printStackTrace();
                ...
                {
Intent intent = new Intent(SplashScreenActivity.this, MainActivity4.class);
...
//        };
    ...
    private void showRegisterLayout() {
        AlertDialog.Builder builder = new AlertDialog.Builder( this, R.style.DialogThemn );

        View itemView = LayoutInflater.from( this ).inflate( R.layout.layout_register, null );

        TextInputEditText edt_first_name = (TextInputEditText) itemView.findViewById( R.id.textInputEditText2 );
        TextInputEditText edt_last_name = (TextInputEditText) itemView.findViewById( R.id.textInputEditText );
        TextInputEditText edt_phone = (TextInputEditText) itemView.findViewById( R.id.textInputEditText3 );

        Button btn_contine = (Button) itemView.findViewById( R.id.button23433 );
        ...
        btn_contine.setOnClickListener( v -> {
            ...
            if (TextUtils.isEmpty( edt_first_name.getText().toString() )) {
                ...
                model.setFirstname( edt_phone.getText().toString() );
                model.getRating( 0.0 );
